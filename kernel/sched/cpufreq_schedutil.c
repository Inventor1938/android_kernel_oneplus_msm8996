...
#define UP_RATE_LATENCY_MULTIPLIER		(500)
#define DOWN_RATE_LATENCY_MULTIPLIER	(1250)
...
static int sugov_init(struct cpufreq_policy *policy)
{
	...
	tunables->up_rate_limit_us = UP_RATE_LATENCY_MULTIPLIER;
	tunables->down_rate_limit_us = DOWN_RATE_LATENCY_MULTIPLIER;
